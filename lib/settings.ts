...
export const DEFAULT_SETTINGS: SiteSettings = {
  ...
  hero: {
    ...
    subheadline:
      "The Bunker brings state-of-the-art indoor golf, lessons, leagues, tournaments, youth programs and community events together in one welcoming Linton destination.",
  },
  simulator: {
    brand: null,
    bay_count: 4,
